...
let filterItems = (arr) => {
  // write a function that will filter the characters with odd id numbers and return the names of those characters in uppercase and in alphabetical order  let filtered = []
